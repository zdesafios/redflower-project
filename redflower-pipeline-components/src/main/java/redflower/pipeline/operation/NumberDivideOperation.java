...
@Component("numberDivide")
@RequiredArgsConstructor
public final class NumberDivideOperation extends DefaultOperation {
	...
	public void onRun(Step stepCurrent, OperationSchema operationSchema, Context context) {
		Number result = calculateDelegate.onRun(stepCurrent, operationSchema, context, new DivideCalculatorStrategy());
 ...
 class DivideCalculatorStrategy implements CalulatorStrategy {
