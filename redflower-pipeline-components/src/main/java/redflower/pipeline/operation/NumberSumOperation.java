...
public final class NumberSumOperation extends DefaultOperation {
	...
	public void onRun(Step stepCurrent, OperationSchema operationSchema, Context context) {
		Number result = calculateDelegate.calculate(stepCurrent, operationSchema, context, new SumCalculatorStrategy());
